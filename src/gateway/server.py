...
# Handling large files in memory will cause performance degradation, an alternative: Gridfs
...
# GridFS uses two collections to store files, one that stores the file chunks and one for the file metadata.
